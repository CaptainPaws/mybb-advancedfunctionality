 ...
 *
 * ВАЖНО для AdvancedEditor:
 *  - Не регистрируем хуки сами. Это делает af_ae_bbcode_dispatch_* в advancededitor.php
 *  - Экспортируем функции:
 *      af_ae_bbcode_spoiler_parse_start(&$message)
 *      af_ae_bbcode_spoiler_parse_end(&$message)
 */

if (!defined('IN_MYBB')) { return; }
if (defined('AF_AE_SPOILER_LOADED')) { return; }
define('AF_AE_SPOILER_LOADED', 1);

function af_aqr_spoiler_mark_text(): string { return 'AF_AQR_SPOILER__MARK__B12C'; }
function af_aqr_spoiler_split_text(): string { return 'AF_AQR_SPOILER__SPLIT__B12C'; }
...
function af_aqr_spoiler_default_title(): string { return 'Спойлер'; }
...
/**
 * START: Оборачиваем spoiler как quote с маркерами до стандартного парсинга MyBB.
 */
function af_ae_bbcode_spoiler_parse_start(&$message): void
{
...
/**
 * END: После стандартного парсинга MyBB превращаем quote-markup в HTML спойлера.
 */
function af_ae_bbcode_spoiler_parse_end(&$message): void
{
