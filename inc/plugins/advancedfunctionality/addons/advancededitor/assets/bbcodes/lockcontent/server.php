...
// === AE dispatcher bridges ===
// packId в manifest.php должен быть: 'lockcontent'
// а tags должны содержать 'hide'

function af_ae_bbcode_lockcontent_parse_start(&$message): void
{
    af_aqr_lockcontent_parse_message_start($message);
}

function af_ae_bbcode_lockcontent_parse_end(&$message): void
{
    af_aqr_lockcontent_parse_message_end($message);
}
