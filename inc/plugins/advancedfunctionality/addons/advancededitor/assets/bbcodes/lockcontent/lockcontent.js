(function () {
  ...
  // ====== AE/AQR совместимость + принудительная регистрация команды (чинит "кнопка не жмётся") ======
  ...
  function install() {
    try {
      ...
      // ключи для мапперов (по handler и по cmd)
      ...
      // главное: перебиваем команду в SCEditor, даже если AE/AQR уже создали заглушку
