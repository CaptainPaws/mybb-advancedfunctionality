...
3. Бестиарий не включён в основной публичный ARPG-каталог этой задачи; может быть добавлен позже как future-compatible (`beast`, `enemy_profile` или `lore`-подтип).
