    ...
    'lang' => [
        'russian' => [
            'front' => [
                ...
                'af_aam_telegram_link' => 'Уведомления в Телеграм',
                'af_aam_telegram_prefs_title' => 'Телеграм',
                'af_aam_telegram_chat_placeholder' => 'ID чата или @username',
                'af_aam_telegram_enable_label' => 'Отправлять уведомления в Телеграм',
            ...
            'admin' => [
                ...
                'af_aam_telegram_enabled'  => 'Телеграм-уведомления',
                'af_aam_telegram_enabled_desc' => 'Отправлять уведомления в бота Telegram.',
                'af_aam_telegram_bot_token' => 'Токен бота',
                'af_aam_telegram_bot_token_desc' => 'Токен, выданный BotFather.',
                'af_aam_telegram_bot_link' => 'Ссылка на бота',
                'af_aam_telegram_bot_link_desc' => 'Публичная ссылка для подключения пользователей к боту.',
            ],
        ],
        'english' => [
            'front' => [
                ...
                'af_aam_telegram_link' => 'Telegram alerts',
                'af_aam_telegram_prefs_title' => 'Telegram',
                'af_aam_telegram_chat_placeholder' => 'Chat ID or @username',
                'af_aam_telegram_enable_label' => 'Send notifications to Telegram',
            ],
            'admin' => [
                ...
                'af_aam_telegram_enabled'  => 'Telegram alerts',
                'af_aam_telegram_enabled_desc' => 'Send notifications to the Telegram bot.',
                'af_aam_telegram_bot_token' => 'Bot token',
                'af_aam_telegram_bot_token_desc' => 'Token issued by BotFather.',
                'af_aam_telegram_bot_link' => 'Bot link',
                'af_aam_telegram_bot_link_desc' => 'Public link for users to connect with the bot.',
            ],
        ],
    ],
];
